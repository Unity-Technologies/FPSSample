Shader "HDRenderPipeline/LitParticle"
{
    Properties
    {
        ...
        [ToggleUI] _FullPerPixelLighting("Per Pixel Lighting", Float) = 1.0
    }
    ...
    #pragma shader_feature LIT_PARTICLE_FULLLIGHTING
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "LitParticleData.hlsl"
            #include "LitParticlesPass.hlsl"
...
#define DIRECTIONAL_SHADOW_MEDIUM
    ...
    CustomEditor "Experimental.Rendering.HDPipeline.LitParticleGUI"
}
